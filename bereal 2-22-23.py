...
async def BeRealNotif():
    while True:
        ...
        await channel.send(role + " :warning: It's time to be real! You have 10 minutes to DM me 2 images. The first image you send will be the smaller image/the selfie. :warning: ")
        await itsTime()
